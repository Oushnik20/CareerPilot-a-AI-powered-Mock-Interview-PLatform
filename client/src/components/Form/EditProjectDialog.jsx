        ...
        <>
            ...
            >
                <div className="fixed inset-0 flex w-screen items-center justify-center p-4 overflow-y-scroll">
                    <DialogPanel className="min-w-xl space-y-4 border bg-card text-foreground rounded-xl px-12 py-6">
                        <div>
                            ...
                            <div className="flex flex-col mt-6 min-w-[50vw]">
                                ...
                                <input
                                    className="bg-card text-foreground p-2 rounded-md mt-2"
                                    type="text"
                                    placeholder="Title"
                                    value={project.title}
                                    onChange={(e) =>
                            ...
                            <div className="flex flex-col mt-5">
                                ...
                                <div className="bg-card text-foreground p-2 rounded-md mt-2">
                                    ...
                                    >
                                        <ComboboxInput
                                            className={`bg-card text-foreground h-[2.25rem] min-w-full border m-[-0.30rem] p-2`}
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <button
                                    className="bg-primary text-primary-foreground p-2 rounded-md mt-5"
                                    onClick={handleEdit}
                                >
                                    Update Project
                                </button>
