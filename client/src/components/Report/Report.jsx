...
const Report = () => {
    ...
    return (
        ...
        >
            ...
            >
                {/* Header */}
                <div className="bg-card rounded-lg p-6 shadow-lg mt-12">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <div className="flex gap-2 items-center w-1/2">
                            ...
                            <span className="text-muted-foreground font-semibold">
                                Total questions answered: {report.totalQuestions}
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {(report.techStacks || []).map((tech, index) => (
                                <span
                                    key={index}
                                    className="px-2 py-1 bg-card text-primary rounded-md text-sm  font-semibold"
                                >
                                    {tech}
                                </span>
                            ))}
                ...
                <div
                    className="fixed bottom-5 right-5 flex items-center justify-center w-12 h-12 text-primary-foreground bg-primary rounded-full shadow-lg cursor-pointer"
                    role="action"
                    onClick={downloadPDF}
                >
